# Data Science Project- Final Project on “Census Income” Dataset
...
census=read.csv("F:\\Academics\\2022- Intellipaat\\Courses\\2022-10-28 Capstone Project- Census Income\\census-income_.csv")
str(census)
library(plyr)
library(dplyr)
library(stringr)
...
# Answers given by intellipaat but none of them work on this dataset
# b) Replace ? with NA
census(census == "?") <- NA
...
# a) Extracting “education” column and storing in “census_ed” 
...
# d)	Extract all the male employees who work in state-gov and store it in “male_gov”.
male_gov=(census$sex=="Male" & census$workclass=="State-gov")
...
census=read.csv("F:\\Academics\\2022- Intellipaat\\Courses\\2022-10-28 Capstone Project- Census Income\\census-income_.csv",stringsAsFactors = T)
library(ggplot2)
library(plotly)
library(reshape2)
...
auc_mullog #Area under the curve: 0.7913
...
7032/(7032+384) # [1] 0.9482201
1165/(1165+1187) # [1] 0.4953231

specificity_dt<-(7032)/(7032+1165)
specificity_dt 
# [1] 0.8578748

misclass_rate_dt<-(384+1187)/sum(table_mat_census_dt)
misclass_rate_dt
# [1] 0.1608313

sum(diag(table_mat_census_dt))/sum(table_mat_census_dt)->acc_census_dt
acc_census_dt #[1] 0.841421
